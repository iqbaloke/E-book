                    ...
                    <td>
                        ...
                        <div class="modal fade" id="exampleModalpublish{{ $book->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalpublishLabel">Do You want to not publish
                                            book {{ $book->title }}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('approvedbookrequest', $book->slug) }}" method="POST">
                                            @csrf
                                            @method("PATCH")
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-secondary btn-sm"
                                                    data-dismiss="modal">Close</button>
                                                <button type="submit" class="btn btn-primary btn-sm">Not Publish book</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
